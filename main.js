...
function checkWindowWidth() {
  ...
  if (windowWidth <= 500) {
    ...
    $(".modal-dialog")
      .removeClass("modal-expanded")
      .addClass("modal-collapsed");
...
function lightModeSettings() {
  ...
  $(".custom-control-label")
    .removeClass("text-color-dark-modified")
    .addClass("text-color-light-modified");
  ...
  if (
    $("#projects").hasClass("nav-active") ||
    $("#about").hasClass("nav-active")
  ) {
    $("#pageBody").removeClass('no-bckg"').addClass("page-body-bckg-light");
  }
}
function darkModeSettings() {
  ...
  $(".project-text")
    .removeClass("text-color-light")
    .addClass("text-color-dark");
  ...
  $(".custom-control-label")
    .removeClass("text-color-light-modified")
    .addClass("text-color-dark-modified");
  $(".project-links").removeClass("links-light").addClass("links-dark");
  $(".caption-text")
    .removeClass("text-color-light")
    .addClass("text-color-dark");
  $(".navbar").addClass("navbar-dark").removeClass("navbar-light");
  $("#pageBody").removeClass("page-body-bckg-light").addClass('no-bckg"');
...
(function (window) {
    ...
    $(".nav-link").on("click", function (event) {
      if (!$("#" + this.id).hasClass("nav-active")) {
        ...
        if (this.id === "projects" || this.id === "about") {
          ...
          // Background grey in light mode on projects and about
          if (!$(darkModeSwitch).prop("checked")) {
            $("#pageBody").addClass("page-body-bckg-light");
            $("#pageBody").removeClass('no-bckg"');
          }
          if (this.id === "about") {
  ...
  function getProjectModalText(containerName) {
    ...
    switch (containerName) {
      ...
      case "ZKeeper":
        titleText = "z-keeper";
        descriptionText = projectData.ZKeeper.descriptionText;
        accomplishmentsText = projectData.ZKeeper.accomplishmentsText;
        imagesText = projectData.ZKeeper.imagesText;
        break;
        case "WICSJobs":
          titleText = "WICS Jobs";
          descriptionText = projectData.WICSJobs.descriptionText;
          accomplishmentsText = projectData.WICSJobs.accomplishmentsText;
          imagesText = projectData.WICSJobs.imagesText;
          break;
      case "VirtualHelp":
      ...
      case "UntitledJaneGame":
        ...
        document.getElementById("code-background-image").className =
          "jane-code";
        break;
